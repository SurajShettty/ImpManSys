...
PERMISSIONS = [
    ...
    # Feature Requests
    {"code": "feature_request.view", "name": "View Feature Requests", "category": "Feature Requests"},
    {"code": "feature_request.create", "name": "Create Feature Requests", "category": "Feature Requests"},
    {"code": "feature_request.update", "name": "Edit Feature Requests", "category": "Feature Requests"},
    {"code": "feature_request.delete", "name": "Delete Feature Requests", "category": "Feature Requests"},
]
